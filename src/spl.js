...
/**
 * @param {ArrayBuffer} [wasmBinary=null]
 * @param {import('./index.mjs').SplOptions} [options={}]
 *
 * @return {import('./index.mjs').Spl}
 */
const spl = function (wasmBinary=null, options = {}) {
    ...
    this.db = function(sqlite3) {
        ...
        const memname = () => `mem-${(Math.round(Number.MAX_SAFE_INTEGER * Math.random()))}.db`;
    ...
    // ]
    //
    this.mount = (path, mountpoint = 'root', options = []) => {
